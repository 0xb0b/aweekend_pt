...
struct Camera
{
  ...
  Camera(Point3f pos, Vector3f lookVec, Vector3f upVec, int xres = default_xresolution,
         int yres = default_yresolution, Degree yfov = Degree(90.0f));

  Camera(Point3f pos, Point3f lookAtPoint, Vector3f upVec, int xres = default_xresolution,
         int yres = default_yresolution, Degree yfov = Degree(90.0f));
};
